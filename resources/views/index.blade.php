        ...
        <div class="container-fluid p-0">
          <div class="hero-wrapper">
            <div class="hero-image">
              <img
                src="{{ asset('assets/img/health/showcase-1.webp') }}"
                  ...
                  >
                    <div class="content-box">
                      <span
                        ...
                        data-aos="fade-up"
                        data-aos-delay="150"
                        >Kepuasan Anda Tujuan Kami</span
                      >
                      ...
                      >
                        ...
                        <a href="{{ route('layanan.layanan') }}" class="btn btn-outline">Lihat Pelayanan Kami</a>
                      </div>
          ...
          <div class="row gy-5 align-items-center">
            <div class="col-lg-6" data-aos="fade-right" data-aos-delay="200">
              <div class="about-image">
                <img
                  src="{{ asset('assets/img/health/facilities-1.webp') }}"
          ...
          <div class="row gy-4">
            ...
            >
              <div class="department-card">
                <div class="department-image">
                  <img
                    src="{{ asset('assets/img/health/cardiology-3.webp') }}"
            ...
            >
              <div class="department-card">
                <div class="department-image">
                  <img
                    src="{{ asset('assets/img/health/neurology-2.webp') }}"
            ...
            >
              <div class="department-card">
                <div class="department-image">
                  <img
                    src="{{ asset('assets/img/health/orthopedics-4.webp') }}"
            ...
            >
              <div class="department-card">
                <div class="department-image">
                  <img
                    src="{{ asset('assets/img/health/pediatrics-3.webp') }}"
            ...
            >
              <div class="department-card">
                <div class="department-image">
                  <img
                    src="{{ asset('assets/img/health/oncology-4.webp') }}"
            ...
            >
              <div class="department-card">
                <div class="department-image">
                  <img
                    src="{{ asset('assets/img/health/emergency-2.webp') }}"
              ...
              <div class="doctor-card">
                <div class="doctor-image">
                  <img
                    ...
                    alt="dr. Azka Putra Rakhmatullah, Sp.An"
                    class="img-fluid"
                  />
                </div>
                <div class="doctor-info">
              ...
              <div class="doctor-card">
                <div class="doctor-image">
                  <img
                    ...
                    alt="dr.Fasya Sophia Septiavina"
                    class="img-fluid"
                  />
                </div>
                <div class="doctor-info">
