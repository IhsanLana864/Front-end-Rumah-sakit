                ...
                <div class="card stretch stretch-full">
                    <div class="card-body p-0">
                        <div class="table-responsive">
                            <table class="table table-hover" id="sosmedTable">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Logo</th>
                                ...
                                <tbody>
                                    @forelse ($sosmeds as $sosmed)
                                        <tr class="single-item">
                                            ...
                                            <td>
                                                <img src="{{ asset('storage/' . $sosmed->logo) }}" alt="Logo" width="50" height="50" style="border-radius: 10px;">
                                            </td>
                                            ...
                                            <td>
                                                <div class="hstack gap-2 justify-content-end">
                                                    <a href="{{ route('admin.sosmed.edit', $sosmed->id) }}" class="avatar-text avatar-md">
                                                        <i class="feather feather-edit-3"></i>
                                                    </a>
                                                    <form action="{{ route('admin.sosmed.destroy', $sosmed->id) }}" method="POST" class="d-inline">
                                                        @csrf
                                                        @method('DELETE')
