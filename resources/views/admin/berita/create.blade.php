    ...
    <div class="main-content">
        <div class="row">
            <div class="card stretch stretch-full">
                <div class="card-body">
                    <form action="{{ route('admin.berita.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                        <div class="row">
                            <div class="col-12 mb-4">
                                <label class="form-label">Gambar berita</label>
                                <input type="file" class="form-control mb-2" id="foto_berita_input" name="gambar" required>
                                @error('gambar')
                                ...
                                <div class="mt-3" id="foto_berita_preview_container" style="display: none;">
                                    <p>Preview Gambar:</p>
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <textarea type="text" class="form-control mb-2" style="height:400px" name="detail" required placeholder="Detail berita"></textarea>
                            </div>
                        </div>
