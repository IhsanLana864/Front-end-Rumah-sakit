    ...
    <div class="main-content">
        <div class="row">
            <div class="card stretch stretch-full">
                <div class="card-body">
                    <form action="{{ route('admin.manajerial.store') }}" enctype="multipart/form-data" method="POST">
                    @csrf
                        <div class="row">
                            <div class="col-12 mb-4">
                                <label class="form-label">Foto Manajerial</label>
                                <input type="file" class="form-control mb-2" id="foto_manajerial_input" name="foto" required>
                                @error('foto')
                            ...
                            <div class="col-12 mb-4">
                                ...
                                <input type="text" class="form-control mb-2" name="nama" required placeholder="Nama manajerial">
                            </div>
