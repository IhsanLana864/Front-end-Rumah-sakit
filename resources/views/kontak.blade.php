          ...
          <div class="contact-wrapper">
            ...
            <div class="contact-form-panel">
              <div class="map-container" style="width: 100%; height: 400px; border-radius: 8px; overflow: hidden;">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3951.776352945151!2d106.91187731526685!3d-7.918432881010376!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2e68e82b73714e6f%3A0x6d9f5a7788484e55!2sRSUD%20Sindangbarang!5e0!3m2!1sen!2sid!4v1672233445566!5m2!1sen!2sid" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
              ...
              <div class="form-container">
                ...
                <form action="#" method="post" class="php-email-form">
                  ...
                  <div class="form-floating mb-3">
                    <input type="email" class="form-control" id="emailInput" name="email" placeholder="Alamat Email" required=""/>
                    <label for="emailInput">Alamat Email</label>
                  </div>

                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="subjectInput" name="subject" placeholder="Subjek" required=""/>
